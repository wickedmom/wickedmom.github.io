...
export class ProgressBar extends React.Component<Props> {
    ...
    loadingAnimation = async () => {
        ...
        while (this.state.loading === true) {
            ...
            await animate.linear(this.animationOpacity, 0, { duration: 0.6 })
                .finished
            await animate.linear(this.animationWidth, 0, { duration: 0 })
                .finished
            await animate.linear(this.animationOpacity, 1, { duration: 0.2 })
                .finished
            currentWidth = Math.min(
                this.props.width,
                currentWidth +
                    (this.props.width / this.props.animationDuration) * 4.7
            )
        }
    }
